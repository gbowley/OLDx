...
# Stores the dictionary mapping Diagnostic Trouble Codes (DTCs) to descriptions.

# DTC definitions (Powertrain, Chassis, Body, Network)
FAULT_TYPE = {
    0b00: 'P', # Powertrain
    0b01: 'C', # Chassis
    0b10: 'B', # Body
...
# Fault status types
FAULTS_CONFIRMED = "confirmed"
FAULTS_PENDING = "pending"
FAULTS_PERMANENT = "permanent" # Not always supported

KNOWN_FAULTS = {
    "B1013": "Frontal airbag RH stage 1 leak to gnd",
    "B1014": "Frontal airbag RH stage 2 leak to gnd",
    "B1015": "Frontal airbag LH stage 1 leak to gnd",
    "B1016": "Frontal airbag LH stage 2 leak to gnd",
    "B1017": "LH pretensioner leak to gnd",
    "B1018": "RH pretensioner leak to gnd",
    "B1019": "Front side airbag driver leak to gnd",
    "B101A": "Frontal airbag RH stage 1 invalid configuration",
    "B101B": "Frontal airbag RH stage 2 invalid configuration",
    "B101C": "Frontal airbag LH stage 1 invalid configuration",
    "B101D": "Frontal airbag LH stage 2 invalid configuration",
    "B101E": "LH pretensioner invalid configuration",
    "B101F": "RH pretensioner invalid configuration",
    "B1021": "Front side airbag passenger leak to gnd",
    "B1024": "Frontal airbag RH stage 1 leak to vbatt",
    "B1025": "Frontal airbag RH stage 2 leak to vbatt",
    "B1026": "Frontal airbag LH stage 1 leak to vbatt",
    "B1027": "Frontal airbag LH stage 2 leak to vbatt",
    "B1028": "LH pretensioner leak to vbatt",
    "B1029": "RH pretensioner leak to vbatt",
    "B102A": "front side airbag driver invalid configuration",
    "B102B": "front side airbag passenger invalid configuration",
    "B1031": "FRONT SIDE AIRBAG DRIVER LEAK TO UBAT",
    "B1032": "FRONT SIDE AIRBAG PASSENGER LEAK TO UBAT",
    "B1035": "FRONTAL AIRBAG RH STAGE 1 LOW RESISTANCE",
    "B1036": "FRONTAL AIRBAG RH STAGE 2 LOW RESISTANCE",
    "B1037": "FRONTAL AIRBAG LH STAGE 1 LOW RESISTANCE",
    "B1038": "FRONTAL AIRBAG LH STAGE 2 LOW RESISTANCE",
    "B1039": "LH PRETENSIONER LOW RESISTANCE",
    "B1041": "RH PRETENSIONER LOW RESISTANCE",
    "B1042": "FRONT SIDE AIRBAG DRIVER LOW RESISTANCE",
    "B1043": "FRONT SIDE AIRBAG PASSENGER LOW RESISTANCE",
    "B1046": "FRONTAL AIRBAG RH STAGE 1 HIGH RESISTANCE",
    "B1047": "FRONTAL AIRBAG RH STAGE 2 HIGH RESISTANCE",
    "B1048": "FRONTAL AIRBAG LH STAGE 1 HIGH RESISTANCE",
    "B1049": "FRONTAL AIRBAG LH STAGE 2 HIGH RESISTANCE",
    "B1051": "LH PRETENSIONER HIGH RESISTANCE",
    "B1052": "RH PRETENSIONER HIGH RESISTANCE",
    "B1053": "FRONT SIDE AIRBAG DRIVER HIGH RESISTANCE",
    "B1054": "front side airbag passenger high resistance",
    "B1063": "AIRBAG OFF SWITCH LEAK TO GROUND/SHORT",
    "B1069": "AIRBAG OFF SWITCH LEAK TO UBAT/OPEN",
    "B106E": "AIRBAG OFF SWITCH INVALID CONFIGURATION",
    "B1071": "LH DOOR P-SAT SENSOR DEFECT",
    "B1072": "LH G-SAT SENSOR DEFECT",
    "B1073": "RH DOOR P-SAT SENSOR DEFECT",
    "B1074": "RH G-SAT SENSOR DEFECT",
    "B1075":"LH DOOR P-SAT SENSOR PARAMETER",
    "B1076":"LH G-SAT SENSOR PARAMETER",
    "B1077":"RH DOOR P-SAT SENSOR PARAMETER",
    "B1078":"RH G-SAT SENSOR PARAMETER",
    "B1079":"LH DOOR P-SAT SENSOR LEAK GND",
    "B107A":"LH G-SAT SENSOR LEAK GND",
    "B107B":"RH DOOR P-SAT SENSOR LEAK GND",
    "B107C":"RH G-SAT SENSOR LEAK GND",
    "B107D":"LH DOOR P-SAT SENSOR LEAK VBATT",
    "B107E":"LH G-SAT SENSOR LEAK VBATT",
    "B107F":"RH DOOR P-SAT SENSOR LEAK VBATT",
    "B1081":"RH G-SAT SENSOR LEAK VBATT",
    "B1082":"LH DOOR P-SAT SENSOR COMMUNICATION ERROR",
    "B1083":"LH G-SAT SENSOR COMMUNICATION ERROR",
    "B1084": "RH DOOR P-SAT SENSOR COMMUNICATION ERROR",
    "B1085": "RH G-SAT SENSOR COMMUNICATION ERROR",
    "B1086": "UNDER VOLTAGE",
    "B1087": "OVER VOLTAGE",
    "B1088": "INTERNAL FAULT (REPLACE SDM)",
    "B1089": "SQUIB CROSSLINK",
    "B1091": "WARNING LAMP FAULT",
    "B1092": "LH AIRBAG DEACTIVATION LAMP FAULT",
    "B1095": "CRASH BELT PRETENSIONERS",
    "B1096": "CRASH SIDE RH",
    "B1097": "CRASH SIDE LH",
    "B1098": "CRASH FRONT",
    ...
    "B1248": "Passenger Seatback Autoglide Rearward Switch Circuit Short to Ground",
    ...
    "B1597": "Driver Seat Seatback Autoglide Forward Switch Circuit Short to Ground",
    "B1598": "Driver Seat Seatback Autoglide Rearward Switch Circuit Short to Ground",
    "B1599": "Passenger Seatback Autoglide Forward Switch Circuit Short to Ground",
    ...
    "B1896": "Driver / Passenger Door Ajar Output Circuit Short to Battery",
    ...
    "B1974": "Passenger Seat Recline Forward Switch Circuit Short to Battery",
    "B1975": "Passenger Seat Recline Back Switch Circuit Short to Battery",
    "B1976": "Passenger Seat Forward Switch Circuit Short to Battery",
    "B1977": "Passenger Front Seat Up Switch Circuit Short to Battery",
    "B1978": "Passenger Front Seat Down Switch Circuit Short to Battery",
    ...
    "B1982": "Driver Door Unlock Relay Circuit Failure",
    ...
    "B1986": "Driver Seat Seatback Autoglide Rearward Switch Circuit Failure",
    ...
    "B2001": "Supply voltage - Circuit voltage below threshold",
    ...
    "C0200": "Wheel speed sensor line failure front right",
    "C0201": "Wheel speed sensor failure front right",
    "C0205": "Wheel speed sensor line failure front left",
    "C0206": "Wheel speed sensor failure front left",
    "C0210": "Wheel speed sensor line failure rear right",
    "C0211": "Wheel speed sensor failure rear right",
    "C0215": "Wheel speed sensor line failure rear left",
    "C0216": "Wheel speed sensor failure rear left",
    "C0222": "Wheel speed monitoring",
    "C0250": "Valve deactivation due to overheat protection at EOL",
    "C0256": "ABS valve failure",
    "C0266": "Reflow pump failure",
    "C0276": "Valve relay",
    "C0281": "Brake fluid level (line open)",
    "C0282": "Brake fluid level",
    "C0286": "Cut valve",
    "C0296": "Suction valve",
    "C0340": "Brake light switch",
    "C0431": "Sensor cluster failure (YAW-rate or Lat acceleration)",
    "C0440": "SAS steering angle sensor fault",
    "C0443": "SAS not calibrated",
    "C0460": "Pressure sensor failure",
    "C0480": "Battery voltage",
    "C0550": "TPMS ECU failure - RAM Failure / Has Malfunctioned. Or Factory inhibit bit",
    "C0551": "TPMS Module not programmed with Vehicle Configuration",
    "C0558": "TPMS Vehicle Sensor IDs not programmed",
    "C0607": "Internal ECU failure",
    ...
    "C1300": "Lost communication with Tire pressure sensor module - Front left wheel",
    "C1303": "Lost communication with Tire pressure sensor module - Front right wheel",
    "C1304": "Lost communication with Tire pressure sensor module - Rear left wheel",
    "C1307": "Lost communication with Tire pressure sensor module - Rear right wheel",
    ...
    "P0095": "Intake Air Temperature Sensor 2 (TMAP) Circuit",
    "P0096": "Intake Air Temperature Sensor 2 (TMAP) Circuit Range/Performance",
    "P0097": "Intake Air Temperature Sensor 2 (TMAP) Circuit Low Input",
    "P0098": "Intake Air Temperature Sensor 2 (TMAP) Circuit High Input",
    "P0099": "Intake Air Temperature Sensor 2 (TMAP) Circuit Intermittent/Erratic",
    ...
    "P0131": "O2 Sensor Circuit Low Voltage (Pre Catalyst) - Bank1",
    "P0132": "O2 Sensor Circuit High Voltage (Pre Catalyst) - Bank1",
    "P0133": "O2 Sensor Circuit Slow Response (Pre Catalyst) - Bank1",
    "P0134": "O2 Sensor Circuit No Activity Detected (Pre Catalyst) - Bank1",
    "P0135": "O2 Sensor Heater Circuit (Pre Catalyst) - Bank1",
    "P0135": "O2 Sensor Heater Circuit Malfunction (Bank 1 Sensor 1)",
    "P0136": "O2 Sensor Circuit Malfunction (Bank 1 Sensor 2)",
    "P0137": "O2 Sensor Circuit Low Voltage (Post Catalyst) - Bank1",
    "P0138": "O2 Sensor Circuit High Voltage (Post Catalyst) - Bank1",
    "P0139": "O2 Sensor Circuit Slow Response (Post Catalyst)",
    "P0140": "O2 Sensor Circuit No Activity Detected (Post Catalyst) - Bank1",
    "P0141": "O2 Sensor Heater Circuit (Post Catalyst) - Bank1",
    ...
    "P0151": "O2 Sensor Circuit Low Voltage (Pre Catalyst) – Bank2",
    "P0152": "O2 Sensor Circuit High Voltage (Pre Catalyst) – Bank2",
    "P0153": "O2 Sensor Circuit Slow Response (Pre Catalyst) – Bank2",
    "P0154": "O2 Sensor Circuit No Activity Detected (Pre Catalyst) – Bank2",
    "P0155": "O2 Sensor Heater Circuit (Pre Catalyst) – Bank2",
    "P0156": "O2 Sensor Circuit Malfunction (Bank 2 Sensor 2)",
    "P0157": "O2 Sensor Circuit Low Voltage (Post Catalyst) – Bank2",
    "P0158": "O2 Sensor Circuit High Voltage (Post Catalyst) – Bank2",
    "P0159": "O2 sensor Circuit Slow Response (Post Catalyst)",
    "P0160": "O2 Sensor Circuit No Activity Detected (Post Catalyst) – Bank2",
    "P0161": "O2 Sensor Heater Circuit (post Catalyst) – Bank2",
    ...
    "P0347": "Camshaft Position Sensor A Circuit Low Input",
    "P0348": "Camshaft Position Sensor A Circuit High Input",
    "P0349": "Camshaft Position Sensor A Circuit Intermittent",
    "P0350": "Ignition Coil Primary/Secondary Circuit Malfunction",
    "P0351": "Ignition Coil A 1 Primary/Secondary Circuit Malfunction",
    ...
    "P0397": "Unknown - please report/contact",
    "P0398": "Unknown - please report/contact",
    "P0399": "Unknown - please report/contact",
    ...
    "P0565": "Cruise control resume/decelerate signal",
    "P0566": "Cruise Control Off Signal Malfunction",
    "P0567": "Cruise control set/accelerate signal",
    "P0568": "Cruise control on/off signal",
    ...
    "P0610": "Variant Code not Programmed or options error",
    ...
    "P0630": "VIN not Programmed or Incompatible/Mismatch ECM",
    ...
    "P0685": "ECM Power Relay Control Circuit Open",
    ...
    "P1104": "Safety Processor Throttle Shutdown",
    "P1105": "Dual Alternator Upper Fault",
    "P1106": "Throttle shutdown by BTO",
    ...
    "P1562": "Battery Voltage Too Low to Complete Throttle Autozero",
    "P1565": "Speed Control Command Switch Out of Range High",
    "P1566": "Speed Control Command Switch Out of Range Low",
    "P1567": "Cruise Resume/Deceleration Switch Intermittent",
    "P1568": "Cruise Set/Acceleration Switch Intermittent",
    ...
    "P1809": "Noisy Clutch Pedal Sensor",
    ...
    "P2122": "Pedal Position Sensor 1 Circuit Low",
    "P2123": "Pedal Position Sensor 1 Circuit High",
    "P2127": "Pedal Position Sensor 2 Circuit Low",
    "P2128": "Pedal Position Sensor 2 Circuit High",
    "P2135": "Throttle Position Sensor Voltage Correlation",
    "P2138": "Pedal Position Sensor Voltage Correlation",
    ...
    "U0001": "High speed CAN communication Bus - Bus off",
    "U0101": "Lost Communications with TCM",
    "U0109": "Lost Communications with fuel pump control module",
    "U0109": "Lost Communications with Fuel Pump Control Module",
    "U0115": "Lost Communications with ECM/PCM B",
    "U0122": "Lost Communications with VDCM",
    "U0122": "Lost Communications with vehicle dynamics control module",
    "U0123": "Lost Communications with Yaw Rate Sensor Module",
    "U0127": "Lost Communications with TPMS Module",
    "U0141": "Lost Communication with Body Control Module A",
    "U0150": "Lost Communication with Gateway E",
    "U0155": "Lost Communication with instrument panel cluster (IPC) control module",
    "U0302": "Software Incompatible with TCM",
    "U0316": "Software Incompatible with VDCM",
    "U0416": "Invalid Data Received from VDCM",
...
def get_fault_description(fault_code_str):
    """Looks up the description for a given fault code string (e.g., 'P0101')."""
    return KNOWN_FAULTS.get(fault_code_str.upper(), "Unknown Fault Code")

def format_fault_code(raw_fault_int):
    """Formats a 16-bit integer fault code into the standard Pxxxx, Cxxxx, etc. format."""
    if not isinstance(raw_fault_int, int):
        return "Invalid Fault Data"
    try:
        fault_type_bits = (raw_fault_int >> 14) & 0b11 # Top 2 bits for type
        fault_num = raw_fault_int & 0x3FFF # Lower 14 bits for number
        fault_letter = FAULT_TYPE.get(fault_type_bits, '?')
        return f"{fault_letter}{fault_num:04X}" # Format number as 4-digit hex
    except Exception:
